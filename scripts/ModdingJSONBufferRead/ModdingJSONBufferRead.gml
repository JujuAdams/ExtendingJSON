...
/// @return Nested struct/array data that represents the contents of the "Modding JSON" string
/// 
...
function ModdingJSONBufferRead(_buffer, _inOffset = undefined)
{
    ...
    while(buffer_tell(_buffer) < _bufferSize)
    {
        ...
        {
            __BufferReadModdingJSONComment(_buffer, _bufferSize);
        }
        else if ((_byte == ord("/")) && (buffer_peek(_buffer, buffer_tell(_buffer), buffer_u8) == ord("*")))
        {
            __BufferReadModdingJSONMultilineComment(_buffer, _bufferSize);
        }
        else if (_byte == ord("["))
        {
            _result = __BufferReadModdingJSONArray(_buffer, _bufferSize);
        }
        else if (_byte == ord("{"))
        {
            _result = __BufferReadModdingJSONStruct(_buffer, _bufferSize);
        }
        else if (_byte == ord("("))
        {
            _result = __BufferReadModdingJSONBracket(_buffer, _bufferSize);
        }
        else if (_byte > 0x20)
        {
...
function __BufferReadModdingJSONArray(_buffer, _bufferSize)
{
    var _result = [];
    ...
    while(buffer_tell(_buffer) < _bufferSize)
    {
        ...
        else if ((_byte == ord(":")) || (_byte == ord("=")) || (_byte == ord(",")))
        {
            show_error("Found unexpected character " + chr(_byte) + " (decimal=" + string(_byte) + ")\nWas expecting a value\n ", true);
        }
        else if (_byte > 0x20)
        {
            var _value = __BufferReadModdingJSONDataValue(_buffer, _bufferSize, _byte);
...
function __BufferReadModdingJSONStruct(_buffer, _bufferSize)
{
    var _result = {};
    ...
    while(buffer_tell(_buffer) < _bufferSize)
    {
        ...
        {
            var _key = __BufferReadModdingJSONDataValue(_buffer, _bufferSize, _byte);
            ...
            else //Is an array
            {
                ...
                repeat(_keyArrayLength-1)
                {
                    ...
                    _result[$ _key] = __BufferReadModdingJSONDeepCopyInner(_value, self, self);
                    ++_i;
                }
            }
...
function __BufferReadModdingJSONDataValue(_buffer, _bufferSize, _firstByte)
{
    if (_firstByte == ord("["))
    {
        return __BufferReadModdingJSONArray(_buffer, _bufferSize);
    }
    else if (_firstByte == ord("{"))
    {
        return __BufferReadModdingJSONStruct(_buffer, _bufferSize);
    }
    else if (_firstByte == ord("("))
    {
        return __BufferReadModdingJSONBracket(_buffer, _bufferSize);
    }
    else if (_firstByte == ord("\""))
    {
        return __BufferReadModdingJSONDelimitedString(_buffer, _bufferSize);
    }
    else if ((_firstByte == ord("@")) && (buffer_peek(_buffer, buffer_tell(_buffer), buffer_u8) == ord("'")))
    {
        buffer_seek(_buffer, buffer_seek_relative, 1);
        return __BufferReadModdingJSONMultilineString(_buffer, _bufferSize);
    }
    else
    {
        return __BufferReadModdingJSONString(_buffer, _bufferSize);
    }
}

function __BufferReadModdingJSONDelimitedString(_buffer, _bufferSize)
{
...
function __BufferReadModdingJSONMultilineString(_buffer, _bufferSize)
{
    static _cacheBuffer = buffer_create(1024, buffer_grow, 1);
    buffer_seek(_cacheBuffer, buffer_seek_start, 0);
...
function __BufferReadModdingJSONString(_buffer, _bufferSize)
{
    static _cacheBuffer = buffer_create(1024, buffer_grow, 1);
    buffer_seek(_cacheBuffer, buffer_seek_start, 0);
...
function __BufferReadModdingJSONComment(_buffer, _bufferSize)
{
    while(buffer_tell(_buffer) < _bufferSize)
    {
        var _byte = buffer_read(_buffer, buffer_u8);
...
function __BufferReadModdingJSONMultilineComment(_buffer, _bufferSize)
{
    while(buffer_tell(_buffer) < _bufferSize)
    {
        var _byte = buffer_read(_buffer, buffer_u8);
...
function __BufferReadModdingJSONDeepCopyInner(_value, _oldStruct, _newStruct)
{
    var _copy = _value;
    ...
    else if (is_struct(_value))
    {
        ...
        repeat(array_length(_namesArray))
        {
            ...
            _copy[$ _name] = __BufferReadModdingJSONDeepCopyInner(_value[$ _name], _value, _copy);
            ++_i;
        }
    }
    else if (is_array(_value))
    {
        ...
        repeat(_count)
        {
            _copy[@ _i] = __BufferReadModdingJSONDeepCopyInner(_value[_i], _oldStruct, _newStruct);
            ++_i;
        }
    }
